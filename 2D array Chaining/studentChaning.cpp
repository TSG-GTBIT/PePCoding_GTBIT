...
int main()
{
	...
	cout<<"Enter Number of rotation.\t";		// getting number of rotation
	cin>>rotate;
	...
	int rStart=0, cStart=0, C=c, R=r;			// looping to rotate each chain
	for(int i=0; i<chainNum ; i++){
		rotateChain(R, C, mat, rotate, rStart, cStart);
		R--;
		C--;
		rStart++;
		cStart++;
